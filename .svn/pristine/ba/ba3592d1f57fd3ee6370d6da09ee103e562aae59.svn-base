 ...
 * @author mariza
 */
public class EntidadLocalServiceClp implements EntidadLocalService {
	public EntidadLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public la.netco.despachos_judiciales.entities.model.Entidad addEntidad(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(entidad) });
		}
		catch (Throwable t) {
		...
		return (la.netco.despachos_judiciales.entities.model.Entidad)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Entidad> getEntidads(
		...
		return (java.util.List<la.netco.despachos_judiciales.entities.model.Entidad>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.despachos_judiciales.entities.model.Entidad updateEntidad(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(entidad), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Entidad> findByFields(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					ClpSerializer.translateInput(mascara),
