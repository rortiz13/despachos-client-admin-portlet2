...
public class RelacionTrabajadorDespachoLocalServiceWrapper
	...
	*/
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho> findByFields(
		...
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return _relacionTrabajadorDespachoLocalService.findByFields(idDespacho,
			idTrabajador, cargo, acuerdo, activo, fecha_ini, fecha_fin,
			secuencia, start, end);
	}
	...
	public java.lang.Integer countByFields(java.lang.String idDespacho,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _relacionTrabajadorDespachoLocalService.countByFields(idDespacho,
			idTrabajador, cargo, acuerdo, activo, fecha_ini, fecha_fin,
			secuencia);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho> createMold()
		throws com.liferay.portal.kernel.exception.SystemException {
		return _relacionTrabajadorDespachoLocalService.createMold();
	}
