...
public class EntidadUtil {
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.Entidad create(
		int codigo) {
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.Entidad remove(
		int codigo)
	...
	public static la.netco.despachos_judiciales.entities.model.Entidad updateImpl(
		la.netco.despachos_judiciales.entities.model.Entidad entidad,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.Entidad findByPrimaryKey(
		int codigo)
		throws com.liferay.portal.kernel.exception.SystemException,
			la.netco.despachos_judiciales.entities.NoSuchEntidadException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.Entidad fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<la.netco.despachos_judiciales.entities.model.Entidad> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static EntidadPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (EntidadPersistence)PortletBeanLocatorUtil.locate(la.netco.despachos_judiciales.entities.service.ClpSerializer.getServletContextName(),
