 ...
 * @author mariza
 */
public class RelacionTrabajadorDespachoLocalServiceClp
	implements RelacionTrabajadorDespachoLocalService {
	public RelacionTrabajadorDespachoLocalServiceClp(
	...
	public la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho addRelacionTrabajadorDespacho(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(relacionTrabajadorDespacho)
					});
		}
		catch (Throwable t) {
		...
		return (la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho> getRelacionTrabajadorDespachos(
		...
		return (java.util.List<la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.RelacionTrabajadorDespacho> findByFields(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					ClpSerializer.translateInput(cargo),
						
					ClpSerializer.translateInput(acuerdo),
						
					ClpSerializer.translateInput(activo),
						
					ClpSerializer.translateInput(fecha_ini),
						
					ClpSerializer.translateInput(fecha_fin),
						
					ClpSerializer.translateInput(secuencia),
