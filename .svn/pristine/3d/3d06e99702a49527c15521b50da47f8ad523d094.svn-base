...
public class EntidadLocalServiceWrapper implements EntidadLocalService,
	...
	*/
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Entidad> findByEstadoDescpacho(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _entidadLocalService.findByEstadoDescpacho(idDepartamento,
			idMunicipio);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Entidad> findByFields(
		...
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return _entidadLocalService.findByFields(idEntidad, nombre, mascara,
			jurisdiccion, start, end);
	}
	...
	public java.lang.Integer countByFields(java.lang.Integer idEntidad,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _entidadLocalService.countByFields(idEntidad, nombre, mascara,
			jurisdiccion);
	}
