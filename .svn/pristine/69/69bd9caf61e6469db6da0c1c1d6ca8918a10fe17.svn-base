...
/**
 * The base implementation of the especialidad local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.EspecialidadLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 ...
 * @generated
 */
public abstract class EspecialidadLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EspecialidadLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.EspecialidadLocalServiceUtil} to access the especialidad local service.
	 */
	...
	public Especialidad addEspecialidad(Especialidad especialidad)
		...
		return especialidadPersistence.update(especialidad, false);
	}
	 ...
	 */
	public Especialidad createEspecialidad(int codigo) {
		return especialidadPersistence.create(codigo);
	}
	...
	public Especialidad deleteEspecialidad(int codigo)
		throws PortalException, SystemException {
		return especialidadPersistence.remove(codigo);
	}
	...
	public Especialidad deleteEspecialidad(Especialidad especialidad)
		throws SystemException {
		return especialidadPersistence.remove(especialidad);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Especialidad.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return especialidadPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return especialidadPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Especialidad fetchEspecialidad(int codigo) throws SystemException {
		return especialidadPersistence.fetchByPrimaryKey(codigo);
	}
	...
	public Especialidad getEspecialidad(int codigo)
		throws PortalException, SystemException {
		return especialidadPersistence.findByPrimaryKey(codigo);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return especialidadPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Especialidad> getEspecialidads(int start, int end)
		throws SystemException {
		return especialidadPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getEspecialidadsCount() throws SystemException {
		return especialidadPersistence.countAll();
	}
	...
	public Especialidad updateEspecialidad(Especialidad especialidad)
		throws SystemException {
		return updateEspecialidad(especialidad, true);
	}
	...
	public Especialidad updateEspecialidad(Especialidad especialidad,
		...
		return especialidadPersistence.update(especialidad, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.Especialidad",
			especialidadLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"la.netco.despachos_judiciales.entities.model.Especialidad");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = especialidadPersistence.getDataSource();
	...
	private EspecialidadLocalServiceClpInvoker _clpInvoker = new EspecialidadLocalServiceClpInvoker();
}