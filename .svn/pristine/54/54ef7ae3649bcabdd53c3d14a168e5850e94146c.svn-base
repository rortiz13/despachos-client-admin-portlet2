...
/**
 * The utility for the departamento local service. This utility wraps {@link la.netco.despachos_judiciales.entities.service.impl.DepartamentoLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see la.netco.despachos_judiciales.entities.service.impl.DepartamentoLocalServiceImpl
 * @generated
 */
public class DepartamentoLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link la.netco.despachos_judiciales.entities.service.impl.DepartamentoLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.Departamento addDepartamento(
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.Departamento createDepartamento(
		int codigo) {
		return getService().createDepartamento(codigo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.Departamento deleteDepartamento(
		int codigo)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteDepartamento(codigo);
	}
	...
	*/
	...
	public static la.netco.despachos_judiciales.entities.model.Departamento fetchDepartamento(
		int codigo) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchDepartamento(codigo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.Departamento getDepartamento(
		int codigo)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getDepartamento(codigo);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<la.netco.despachos_judiciales.entities.model.Departamento> getDepartamentos(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.Departamento updateDepartamento(
		la.netco.despachos_judiciales.entities.model.Departamento departamento)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static java.util.List<la.netco.despachos_judiciales.entities.model.Departamento> findByFields(
		...
		int end) throws com.liferay.portal.kernel.exception.SystemException {
		return getService().findByFields(idDepartamento, nombre, start, end);
	}

	public static java.lang.Integer countByFields(
		java.lang.Integer idDepartamento, java.lang.String nombre)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().countByFields(idDepartamento, nombre);
	}
