...
/**
 * The base model interface for the Especialidad service. Represents a row in the &quot;GLO_ESPECIALIDAD&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link la.netco.despachos_judiciales.entities.model.impl.EspecialidadModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link la.netco.despachos_judiciales.entities.model.impl.EspecialidadImpl}.
 * </p>
 *
 * @author mariza
 * @see Especialidad
 * @see la.netco.despachos_judiciales.entities.model.impl.EspecialidadImpl
 * @see la.netco.despachos_judiciales.entities.model.impl.EspecialidadModelImpl
 * @generated
 */
