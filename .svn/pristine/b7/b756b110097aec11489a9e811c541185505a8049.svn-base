 ...
 * @author mariza
 */
public class TrabajadorLocalServiceClp implements TrabajadorLocalService {
	public TrabajadorLocalServiceClp(
		...
		_methodName19 = "findByDespachoRelacion";
	...
	public la.netco.despachos_judiciales.entities.model.Trabajador addTrabajador(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(trabajador) });
		}
		catch (Throwable t) {
		...
		return (la.netco.despachos_judiciales.entities.model.Trabajador)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.despachos_judiciales.entities.model.Trabajador createTrabajador(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					...
					new Object[] { ClpSerializer.translateInput(cedula) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Trabajador> getTrabajadors(
		...
		return (java.util.List<la.netco.despachos_judiciales.entities.model.Trabajador>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.despachos_judiciales.entities.model.Trabajador updateTrabajador(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(trabajador), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Trabajador> findByDespachoRelacion(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { ClpSerializer.translateInput(idDespacho) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Trabajador> findByFields(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName20,
					...
					new Object[] {
						ClpSerializer.translateInput(idTrabajador),
						
					ClpSerializer.translateInput(nombres),
						
					ClpSerializer.translateInput(apellidos),
						
					ClpSerializer.translateInput(especialidad),
						
					ClpSerializer.translateInput(correo),
						
					ClpSerializer.translateInput(telefonos),
						
					ClpSerializer.translateInput(carrera),
						
					ClpSerializer.translateInput(tipoTrabajador),
						
					ClpSerializer.translateInput(tipoContrato),
