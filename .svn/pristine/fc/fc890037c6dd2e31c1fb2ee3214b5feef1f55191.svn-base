 ...
 * @author mariza
 */
public class RelacionUsuarioConsejoLocalServiceClp
	implements RelacionUsuarioConsejoLocalService {
	public RelacionUsuarioConsejoLocalServiceClp(
	...
	public la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo addRelacionUsuarioConsejo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] {
						ClpSerializer.translateInput(relacionUsuarioConsejo)
					});
		}
		catch (Throwable t) {
		...
		return (la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo createRelacionUsuarioConsejo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { idConsejoSec });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo deleteRelacionUsuarioConsejo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { idConsejoSec });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo fetchRelacionUsuarioConsejo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { idConsejoSec });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo getRelacionUsuarioConsejo(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { idConsejoSec });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo> getRelacionUsuarioConsejos(
		...
		return (java.util.List<la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo>)ClpSerializer.translateOutput(returnObj);
	}
