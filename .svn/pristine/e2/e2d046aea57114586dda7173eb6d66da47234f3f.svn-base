...
import la.netco.despachos_judiciales.entities.model.impl.EntidadModelImpl;
...
public class EntidadPersistenceImpl extends BasePersistenceImpl<Entidad>
	 ...
	 */
	public Entidad create(int codigo) {
	 ...
	 */
	public Entidad remove(int codigo)
	...
	protected Entidad toUnwrappedModel(Entidad entidad) {
		...
		entidadImpl.setMascara(entidad.getMascara());
		entidadImpl.setJurisdiccion(entidad.getJurisdiccion());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entidad findByPrimaryKey(int codigo)
		throws NoSuchEntidadException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Entidad fetchByPrimaryKey(int codigo) throws SystemException {
		...
		if (entidad == null) {
			...
			try {
				...
				entidad = (Entidad)session.get(EntidadImpl.class,
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.la.netco.despachos_judiciales.entities.model.Entidad")));
