...
/**
 * The base implementation of the consejo seccional local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.ConsejoSeccionalLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 ...
 * @generated
 */
public abstract class ConsejoSeccionalLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements ConsejoSeccionalLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.ConsejoSeccionalLocalServiceUtil} to access the consejo seccional local service.
	 */
	...
	public ConsejoSeccional addConsejoSeccional(
		ConsejoSeccional consejoSeccional) throws SystemException {
		consejoSeccional.setNew(true);

		return consejoSeccionalPersistence.update(consejoSeccional, false);
	}
	 ...
	 */
	public ConsejoSeccional createConsejoSeccional(int codigo) {
		return consejoSeccionalPersistence.create(codigo);
	}
	...
	public ConsejoSeccional deleteConsejoSeccional(int codigo)
		throws PortalException, SystemException {
		return consejoSeccionalPersistence.remove(codigo);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public ConsejoSeccional deleteConsejoSeccional(
		ConsejoSeccional consejoSeccional) throws SystemException {
		return consejoSeccionalPersistence.remove(consejoSeccional);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(ConsejoSeccional.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return consejoSeccionalPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return consejoSeccionalPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public ConsejoSeccional fetchConsejoSeccional(int codigo)
		throws SystemException {
		return consejoSeccionalPersistence.fetchByPrimaryKey(codigo);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public ConsejoSeccional getConsejoSeccional(int codigo)
		throws PortalException, SystemException {
		return consejoSeccionalPersistence.findByPrimaryKey(codigo);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return consejoSeccionalPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<ConsejoSeccional> getConsejoSeccionals(int start, int end)
		throws SystemException {
		return consejoSeccionalPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getConsejoSeccionalsCount() throws SystemException {
		return consejoSeccionalPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public ConsejoSeccional updateConsejoSeccional(
		ConsejoSeccional consejoSeccional) throws SystemException {
		return updateConsejoSeccional(consejoSeccional, true);
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	public ConsejoSeccional updateConsejoSeccional(
		ConsejoSeccional consejoSeccional, boolean merge)
		throws SystemException {
		consejoSeccional.setNew(false);

		return consejoSeccionalPersistence.update(consejoSeccional, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.ConsejoSeccional",
			consejoSeccionalLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = consejoSeccionalPersistence.getDataSource();
	...
	private ConsejoSeccionalLocalServiceClpInvoker _clpInvoker = new ConsejoSeccionalLocalServiceClpInvoker();
}