...
/**
 * The persistence utility for the consejo seccional service. This utility wraps {@link ConsejoSeccionalPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class ConsejoSeccionalUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public static void clearCache(ConsejoSeccional consejoSeccional) {
		getPersistence().clearCache(consejoSeccional);
	}
	 ...
	 */
	public static List<ConsejoSeccional> findWithDynamicQuery(
	 ...
	 */
	public static ConsejoSeccional update(ConsejoSeccional consejoSeccional,
		boolean merge) throws SystemException {
		return getPersistence().update(consejoSeccional, merge);
	}
	...
	public static ConsejoSeccional update(ConsejoSeccional consejoSeccional,
		...
		return getPersistence().update(consejoSeccional, merge, serviceContext);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(consejoSeccional);
	}
	...
	*/
	public static void cacheResult(
		...
		getPersistence().cacheResult(consejoSeccionals);
	}
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.ConsejoSeccional create(
		int codigo) {
	...
	*/
	public static la.netco.despachos_judiciales.entities.model.ConsejoSeccional remove(
		int codigo)
	...
	public static la.netco.despachos_judiciales.entities.model.ConsejoSeccional updateImpl(
		la.netco.despachos_judiciales.entities.model.ConsejoSeccional consejoSeccional,
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getPersistence().updateImpl(consejoSeccional, merge);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.ConsejoSeccional findByPrimaryKey(
		int codigo)
		throws com.liferay.portal.kernel.exception.SystemException,
			la.netco.despachos_judiciales.entities.NoSuchConsejoSeccionalException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static la.netco.despachos_judiciales.entities.model.ConsejoSeccional fetchByPrimaryKey(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<la.netco.despachos_judiciales.entities.model.ConsejoSeccional> findAll()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static ConsejoSeccionalPersistence getPersistence() {
		if (_persistence == null) {
			_persistence = (ConsejoSeccionalPersistence)PortletBeanLocatorUtil.locate(la.netco.despachos_judiciales.entities.service.ClpSerializer.getServletContextName(),
					ConsejoSeccionalPersistence.class.getName());

			ReferenceRegistry.registerReference(ConsejoSeccionalUtil.class,
				"_persistence");
		}
	 ...
	 * @deprecated
	 */
	public void setPersistence(ConsejoSeccionalPersistence persistence) {
	}

	private static ConsejoSeccionalPersistence _persistence;
}