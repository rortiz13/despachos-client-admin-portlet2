 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.DepartamentoLocalServiceImpl}.
 * </p>
 *
 * @author mariza
...
public abstract class DepartamentoLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.DepartamentoLocalServiceUtil} to access the departamento local service.
	 */
	 ...
	 */
	public Departamento createDepartamento(int codigo) {
		return departamentoPersistence.create(codigo);
	}
	...
	public Departamento deleteDepartamento(int codigo)
		throws PortalException, SystemException {
		return departamentoPersistence.remove(codigo);
	}
	...
	public Departamento fetchDepartamento(int codigo) throws SystemException {
		return departamentoPersistence.fetchByPrimaryKey(codigo);
	}
	...
	public Departamento getDepartamento(int codigo)
		throws PortalException, SystemException {
		return departamentoPersistence.findByPrimaryKey(codigo);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.Departamento",
