 ...
 * @author mariza
 */
public class DistritoLocalServiceClp implements DistritoLocalService {
	public DistritoLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public la.netco.despachos_judiciales.entities.model.Distrito addDistrito(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(distrito) });
		}
		catch (Throwable t) {
		...
		return (la.netco.despachos_judiciales.entities.model.Distrito)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Distrito> getDistritos(
		...
		return (java.util.List<la.netco.despachos_judiciales.entities.model.Distrito>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public la.netco.despachos_judiciales.entities.model.Distrito updateDistrito(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(distrito), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
