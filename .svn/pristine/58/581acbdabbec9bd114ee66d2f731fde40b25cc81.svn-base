...
public class ConsejoSeccionalLocalServiceWrapper
	...
	*/
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.ConsejoSeccional> findByDespacho(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _consejoSeccionalLocalService.findByDespacho(idDepartamento,
			idMunicipio);
	}
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.ConsejoSeccional> findByFields(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _consejoSeccionalLocalService.findByFields(idConsejoSec, nombre,
			direccion, telefonos, correo_electronico, start, end);
	}
	...
	public java.lang.Integer countByFields(java.lang.Integer idConsejoSec,
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _consejoSeccionalLocalService.countByFields(idConsejoSec,
			nombre, direccion, telefonos, correo_electronico);
	}
