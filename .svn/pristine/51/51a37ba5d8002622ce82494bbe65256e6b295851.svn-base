...
public class MunicipioLocalServiceClp implements MunicipioLocalService {
	public MunicipioLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName20 = "findByCompositeKey";

		_methodParameterTypes20 = new String[] {
				"java.lang.Integer", "java.lang.Integer"
			};

		_methodName21 = "findByFields";
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Municipio> findByEstadoDescpacho(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { ClpSerializer.translateInput(idDepartamento) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<la.netco.despachos_judiciales.entities.model.Municipio> findByFields(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName21,
					...
					ClpSerializer.translateInput(indicativo),
						
					ClpSerializer.translateInput(idCircuito),
						
					ClpSerializer.translateInput(idCircuitoAdministrativo),
						
					ClpSerializer.translateInput(idConsejoSeccional),
						
					ClpSerializer.translateInput(idCircuitoDisciplinario),
