...
import la.netco.despachos_judiciales.entities.NoSuchDepartamentoException;
...
import la.netco.despachos_judiciales.entities.model.impl.DepartamentoModelImpl;
...
public class DepartamentoPersistenceImpl extends BasePersistenceImpl<Departamento>
	 ...
	 */
	public Departamento create(int codigo) {
		Departamento departamento = new DepartamentoImpl();

		departamento.setNew(true);
		departamento.setPrimaryKey(codigo);
	 ...
	 */
	public Departamento remove(int codigo)
	...
	protected Departamento toUnwrappedModel(Departamento departamento) {
		...
		departamentoImpl.setCodigo(departamento.getCodigo());
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Departamento findByPrimaryKey(int codigo)
		throws NoSuchDepartamentoException, SystemException {
		Departamento departamento = fetchByPrimaryKey(codigo);
		...
		if (departamento == null) {
			...
			try {
				...
				if (departamento != null) {
					...
					EntityCacheUtil.putResult(DepartamentoModelImpl.ENTITY_CACHE_ENABLED,
						DepartamentoImpl.class, codigo, _nullDepartamento);
				}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.la.netco.despachos_judiciales.entities.model.Departamento")));
