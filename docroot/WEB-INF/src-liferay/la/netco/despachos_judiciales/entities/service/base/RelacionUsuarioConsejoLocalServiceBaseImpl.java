...
/**
 * The base implementation of the relacion usuario consejo local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.RelacionUsuarioConsejoLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 ...
 * @generated
 */
public abstract class RelacionUsuarioConsejoLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements RelacionUsuarioConsejoLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.RelacionUsuarioConsejoLocalServiceUtil} to access the relacion usuario consejo local service.
	 */
	...
	public RelacionUsuarioConsejo addRelacionUsuarioConsejo(
		RelacionUsuarioConsejo relacionUsuarioConsejo)
		throws SystemException {
		relacionUsuarioConsejo.setNew(true);

		return relacionUsuarioConsejoPersistence.update(relacionUsuarioConsejo,
			false);
	}
	 ...
	 */
	public RelacionUsuarioConsejo createRelacionUsuarioConsejo(int idConsejoSec) {
		return relacionUsuarioConsejoPersistence.create(idConsejoSec);
	}
	...
	public RelacionUsuarioConsejo deleteRelacionUsuarioConsejo(int idConsejoSec)
		throws PortalException, SystemException {
		return relacionUsuarioConsejoPersistence.remove(idConsejoSec);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public RelacionUsuarioConsejo deleteRelacionUsuarioConsejo(
		RelacionUsuarioConsejo relacionUsuarioConsejo)
		throws SystemException {
		return relacionUsuarioConsejoPersistence.remove(relacionUsuarioConsejo);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(RelacionUsuarioConsejo.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return relacionUsuarioConsejoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return relacionUsuarioConsejoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public RelacionUsuarioConsejo fetchRelacionUsuarioConsejo(int idConsejoSec)
		throws SystemException {
		return relacionUsuarioConsejoPersistence.fetchByPrimaryKey(idConsejoSec);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public RelacionUsuarioConsejo getRelacionUsuarioConsejo(int idConsejoSec)
		throws PortalException, SystemException {
		return relacionUsuarioConsejoPersistence.findByPrimaryKey(idConsejoSec);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return relacionUsuarioConsejoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<RelacionUsuarioConsejo> getRelacionUsuarioConsejos(int start,
		int end) throws SystemException {
		return relacionUsuarioConsejoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getRelacionUsuarioConsejosCount() throws SystemException {
		return relacionUsuarioConsejoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public RelacionUsuarioConsejo updateRelacionUsuarioConsejo(
		RelacionUsuarioConsejo relacionUsuarioConsejo)
		throws SystemException {
		return updateRelacionUsuarioConsejo(relacionUsuarioConsejo, true);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.RelacionUsuarioConsejo",
			relacionUsuarioConsejoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = relacionUsuarioConsejoPersistence.getDataSource();
	...
	private RelacionUsuarioConsejoLocalServiceClpInvoker _clpInvoker = new RelacionUsuarioConsejoLocalServiceClpInvoker();
}