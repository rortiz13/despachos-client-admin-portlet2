...
/**
 * The base implementation of the trabajador local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.TrabajadorLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 * @see la.netco.despachos_judiciales.entities.service.impl.TrabajadorLocalServiceImpl
 * @see la.netco.despachos_judiciales.entities.service.TrabajadorLocalServiceUtil
 * @generated
 */
public abstract class TrabajadorLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements TrabajadorLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.TrabajadorLocalServiceUtil} to access the trabajador local service.
	 */
	...
	public Trabajador addTrabajador(Trabajador trabajador)
		...
		return trabajadorPersistence.update(trabajador, false);
	}
	 ...
	 */
	public Trabajador createTrabajador(String cedula) {
		return trabajadorPersistence.create(cedula);
	}
	...
	public Trabajador deleteTrabajador(String cedula)
		throws PortalException, SystemException {
		return trabajadorPersistence.remove(cedula);
	}
	...
	public Trabajador deleteTrabajador(Trabajador trabajador)
		throws SystemException {
		return trabajadorPersistence.remove(trabajador);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Trabajador.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return trabajadorPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return trabajadorPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return trabajadorPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Trabajador fetchTrabajador(String cedula) throws SystemException {
		return trabajadorPersistence.fetchByPrimaryKey(cedula);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Trabajador getTrabajador(String cedula)
		throws PortalException, SystemException {
		return trabajadorPersistence.findByPrimaryKey(cedula);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return trabajadorPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Trabajador> getTrabajadors(int start, int end)
		throws SystemException {
		return trabajadorPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getTrabajadorsCount() throws SystemException {
		return trabajadorPersistence.countAll();
	}
	...
	public Trabajador updateTrabajador(Trabajador trabajador)
		throws SystemException {
		return updateTrabajador(trabajador, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Trabajador updateTrabajador(Trabajador trabajador, boolean merge)
		throws SystemException {
		trabajador.setNew(false);

		return trabajadorPersistence.update(trabajador, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.Trabajador",
			trabajadorLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"la.netco.despachos_judiciales.entities.model.Trabajador");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = trabajadorPersistence.getDataSource();
	...
	private TrabajadorLocalServiceClpInvoker _clpInvoker = new TrabajadorLocalServiceClpInvoker();
}