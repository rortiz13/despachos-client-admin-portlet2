...
/**
 * The base implementation of the circuito local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.CircuitoLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 ...
 * @generated
 */
public abstract class CircuitoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements CircuitoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.CircuitoLocalServiceUtil} to access the circuito local service.
	 */
	...
	public Circuito addCircuito(Circuito circuito) throws SystemException {
		circuito.setNew(true);

		return circuitoPersistence.update(circuito, false);
	}
	 ...
	 */
	public Circuito createCircuito(int codigo) {
		return circuitoPersistence.create(codigo);
	}
	...
	public Circuito deleteCircuito(int codigo)
		throws PortalException, SystemException {
		return circuitoPersistence.remove(codigo);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Circuito deleteCircuito(Circuito circuito) throws SystemException {
		return circuitoPersistence.remove(circuito);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Circuito.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return circuitoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return circuitoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return circuitoPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return circuitoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Circuito fetchCircuito(int codigo) throws SystemException {
		return circuitoPersistence.fetchByPrimaryKey(codigo);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Circuito getCircuito(int codigo)
		throws PortalException, SystemException {
		return circuitoPersistence.findByPrimaryKey(codigo);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return circuitoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Circuito> getCircuitos(int start, int end)
		throws SystemException {
		return circuitoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCircuitosCount() throws SystemException {
		return circuitoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Circuito updateCircuito(Circuito circuito) throws SystemException {
		return updateCircuito(circuito, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Circuito updateCircuito(Circuito circuito, boolean merge)
		throws SystemException {
		circuito.setNew(false);

		return circuitoPersistence.update(circuito, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.Circuito",
			circuitoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = circuitoPersistence.getDataSource();
	...
	private CircuitoLocalServiceClpInvoker _clpInvoker = new CircuitoLocalServiceClpInvoker();
}