...
/**
 * The base implementation of the distrito local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link la.netco.despachos_judiciales.entities.service.impl.DistritoLocalServiceImpl}.
 * </p>
 *
 * @author mariza
 ...
 * @generated
 */
public abstract class DistritoLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DistritoLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link la.netco.despachos_judiciales.entities.service.DistritoLocalServiceUtil} to access the distrito local service.
	 */
	...
	public Distrito addDistrito(Distrito distrito) throws SystemException {
		distrito.setNew(true);

		return distritoPersistence.update(distrito, false);
	}
	 ...
	 */
	public Distrito createDistrito(int codigo) {
		return distritoPersistence.create(codigo);
	}
	...
	public Distrito deleteDistrito(int codigo)
		throws PortalException, SystemException {
		return distritoPersistence.remove(codigo);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Distrito deleteDistrito(Distrito distrito) throws SystemException {
		return distritoPersistence.remove(distrito);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(Distrito.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return distritoPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return distritoPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return distritoPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return distritoPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public Distrito fetchDistrito(int codigo) throws SystemException {
		return distritoPersistence.fetchByPrimaryKey(codigo);
	}
	...
	public Distrito getDistrito(int codigo)
		throws PortalException, SystemException {
		return distritoPersistence.findByPrimaryKey(codigo);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return distritoPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Distrito> getDistritos(int start, int end)
		throws SystemException {
		return distritoPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDistritosCount() throws SystemException {
		return distritoPersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Distrito updateDistrito(Distrito distrito) throws SystemException {
		return updateDistrito(distrito, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Distrito updateDistrito(Distrito distrito, boolean merge)
		throws SystemException {
		distrito.setNew(false);

		return distritoPersistence.update(distrito, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("la.netco.despachos_judiciales.entities.model.Distrito",
			distritoLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = distritoPersistence.getDataSource();
	...
	private DistritoLocalServiceClpInvoker _clpInvoker = new DistritoLocalServiceClpInvoker();
}